...
Este repositório contém 15 notebooks em Python desenvolvidos para praticar conceitos fundamentais de **Ciência de Dados** utilizando o dataset `tmdb_5000_movies.csv`.
...
2. Copie os blocos de código abaixo e execute no VS Code ou Jupyter Notebook
3. Os códigos são independentes, você pode rodar qualquer um sem seguir ordem rígida
